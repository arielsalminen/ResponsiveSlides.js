...
function(a){a.preventDefault();a=e.index(c("."+f))-1;if(c("."+f+":animated").length)return!1;q();i(a);!0===b.pagination&&k(a)}),d.on("click",function(a){a.preventDefault();a=e.index(c("."+f))+1<s?h+1:0;if(c("."+f+":animated").length)return!1;q();i(a);!0===b.pagination&&k(a)}));if("undefined"===typeof document.body.style.maxWidth&&l&&l.maxwidth){var x=function(){g.css("width","100%");g.width()>b.maxwidth&&g.css("width",b.maxwidth)};x();c(y).on("resize",function(){x()})}})}})(jQuery,this,0);