...
a=e.index(b("."+f))-1;if(b("."+f+":animated").length)return!1;q();i(a);k(a)}),d.on("click",function(a){a.preventDefault();a=e.index(b("."+f))+1<s?h+1:0;if(b("."+f+":animated").length)return!1;q();i(a);k(a)}));if("undefined"===typeof document.body.style.maxWidth&&l&&l.maxwidth){var x=function(){g.css("width","100%");g.width()>c.maxwidth&&g.css("width",c.maxwidth)};x();b(y).on("resize",function(){x()})}})}})(jQuery,this,0);